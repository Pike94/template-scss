...
gulp.task('watch', function() {
    gulp.watch(['src/templates/*.html', 'src/chunks/*.html'], function() { runSequence('html-build', 'server-reload', 'html-hint') });
    gulp.watch('src/css/*.css', function() { runSequence('css-libs', 'server-reload') });
    gulp.watch('src/scss/**/*.scss', function() { runSequence('sass', 'server-reload') });
    gulp.watch(['src/img/**/*.{png,jpg,bmp,gif,svg}', '!src/img/svg-source/*.svg'], function() { runSequence('copy-img', 'server-reload') });
    gulp.watch('src/img/svg-source/*.svg', function() { runSequence('svg-sprite', 'server-reload') });
    gulp.watch('src/fonts/*.{ttf,woff,woff2,eot,svg}', function() { runSequence('copy-fonts', 'server-reload') });
    gulp.watch('src/json/**/*.json', function() { runSequence('copy-json', 'server-reload') });
    gulp.watch('src/js/lib/*.js', function() { runSequence('js-libs', 'server-reload') });
    gulp.watch('src/js/*.js', function() { runSequence('js-modules', 'server-reload') });
});
